 ...
 */
public class AwolowoMarketFragment extends Fragment {


    public AwolowoMarketFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        facilities.add(new Facility("Awolowo Market", "Station",
                "Get fruits, perishables, ankara and lace materials and many more",
                "Open 7 a.m to 7 p.m daily\nSpecial market days: Every four days",
                R.drawable.market));
