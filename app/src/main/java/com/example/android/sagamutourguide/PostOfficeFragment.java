 ...
 */
public class PostOfficeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        facilities.add(new Facility("Post Office", "Ewusi street, Makun",
                "Send and receive items, domestic and international.", R.drawable.office));
