 ...
 */
public class RightOptionsFragment extends Fragment {


    public RightOptionsFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        facilities.add(new Facility("Right Options", "Isale Oko",
                "Eat-in and take-away", "Open 9 a.m to 7 p.m daily",
                "Contact\n08012345678", R.drawable.restaurant));
