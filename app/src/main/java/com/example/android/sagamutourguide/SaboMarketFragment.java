 ...
 */
public class SaboMarketFragment extends Fragment {


    public SaboMarketFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        facilities.add(new Facility("Sabo Market", "Sabo",
                "Shop for foodstuffs, groceries, raw food items, perishables and lots more",
                "Open 7 a.m to 7 p.m daily\nThursdays: Open from 10 a.m",
                R.drawable.market));
