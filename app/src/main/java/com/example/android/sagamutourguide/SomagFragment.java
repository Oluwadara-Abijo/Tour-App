 ...
 */
public class SomagFragment extends Fragment {


    public SomagFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        facilities.add(new Facility("Somag Supermarket", "Beside Mr. Biggs, Sabo",
                "Shop for your groceries and household materials.",
